...
ns._activeTranslation = {
    ...
    ["Syncing"] = "동기화 중",
    ["Loading"] = "로딩 중",
    ["Rewards pending"] = "보상 대기 중",
    ["Syncing rewards"] = "보상 동기화 중",
    ["No reward choices"] = "보상 선택지 없음",
    ["%d reward choices"] = "보상 선택지 %d개",
    ["Unknown reward"] = "알 수 없는 보상",
    ["Quantity: %s"] = "수량: %s",
    ["Hunt Sync"] = "사냥 동기화",
    ["No hunt signals detected."] = "사냥 신호가 감지되지 않았습니다.",
    ["Band %s | Active %d | Ready %d"] = "구분 %s | 진행 %d | 준비 %d",
    ["Tactical Hunt Console"] = "전술 사냥 콘솔",
    ["Live prey routing, reward telemetry, and one-click quest access"] = "실시간 먹잇감 추적, 보상 텔레메트리, 원클릭 퀘스트 접근",
    ["Detach"] = "분리",
    ["Dock"] = "도킹",
    ["Synchronizing hunt deck"] = "사냥 목록 동기화 중",
    ["Stabilizing hunt signals"] = "사냥 신호 안정화 중",
    ["Stabilizing map pins"] = "지도 핀 안정화 중",

...
ns._activeTranslation = {
    ...
    ["Keep the tracker attached to the prey icon and nudge it into place."] = "Mantén el rastreador unido al ícono de presa y ajústalo en su posición.",
    ...
    ["Adjust tracker text styling without adding a hard dependency. LibSharedMedia fonts appear automatically when the library is installed."] = "Ajusta el estilo del texto del rastreador sin agregar una dependencia obligatoria. Las fuentes de LibSharedMedia aparecen automáticamente cuando la biblioteca está instalada.",

...
ns._activeTranslation = {
    ...
    ["Commands: /pb, /pb settings, /pb toggle, /pb refresh, /pb hunts, /pb reset, /pb debug, /pb diag, /pb mapdump"] = "Comandos: /pb, /pb settings, /pb toggle, /pb refresh, /pb hunts, /pb reset, /pb debug, /pb diag, /pb mapdump",
    ["=== Prey Hunt Badge Diagnostic ==="] = "=== Diagnóstico del emblema de cacería de presa ===",
    ["No active hunt pins found."] = "No se encontraron marcadores de cacería activos.",
    ["Unknown prey"] = "Presa desconocida",
    ["Unknown difficulty"] = "Dificultad desconocida",
    ["Unknown zone"] = "Zona desconocida",
    ["show icon"] = "mostrar ícono",
    ["hide icon"] = "ocultar ícono",
    ["none"] = "ninguno",
    ["Difficulty: %s"] = "Dificultad: %s",
    ["This Prey target is a requirement for an unearned achievement."] = "Este objetivo de presa es necesario para un logro que aún no has obtenido.",
    ...
    ["Loading"] = "Cargando",
    ["Rewards pending"] = "Recompensas pendientes",
    ["Syncing rewards"] = "Sincronizando recompensas",
    ["No reward choices"] = "Sin opciones de recompensa",
    ["%d reward choices"] = "%d opciones de recompensa",
    ["Unknown reward"] = "Recompensa desconocida",
    ["Quantity: %s"] = "Cantidad: %s",
    ["Hunt Sync"] = "Sincronización de cacería",
    ["No hunt signals detected."] = "No se detectaron señales de cacería.",
    ["Band %s | Active %d | Ready %d"] = "Banda %s | Activas %d | Listas %d",
    ["Tactical Hunt Console"] = "CONSOLA TACTICA DE CACERIA",
    ["Live prey routing, reward telemetry, and one-click quest access"] = "Rastreo de presa en vivo, telemetría de recompensas y acceso a misión con un clic",
    ["Detach"] = "Desacoplar",
    ["Dock"] = "Acoplar",
    ["Synchronizing hunt deck"] = "Sincronizando lista de cacerías",
    ["Stabilizing hunt signals"] = "Estabilizando señales de cacería",
    ["Stabilizing map pins"] = "Estabilizando marcadores del mapa",

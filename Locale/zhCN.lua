...
ns._activeTranslation = {
    ...
    ["Syncing"] = "同步中",
    ["Loading"] = "加载中",
    ["Rewards pending"] = "奖励待定",
    ["Syncing rewards"] = "正在同步奖励",
    ["No reward choices"] = "没有奖励选项",
    ["%d reward choices"] = "%d个奖励选项",
    ["Unknown reward"] = "未知奖励",
    ["Quantity: %s"] = "数量：%s",
    ["Hunt Sync"] = "狩猎同步",
    ["No hunt signals detected."] = "未检测到狩猎信号。",
    ["Band %s | Active %d | Ready %d"] = "筛选%s | 进行中%d | 就绪%d",
    ["Tactical Hunt Console"] = "战术狩猎控制台",
    ["Live prey routing, reward telemetry, and one-click quest access"] = "实时猎物追踪、奖励遥测和一键任务访问",
    ["Detach"] = "分离",
    ["Dock"] = "停靠",
    ["Synchronizing hunt deck"] = "正在同步狩猎列表",
    ["Stabilizing hunt signals"] = "正在稳定狩猎信号",
    ["Stabilizing map pins"] = "正在稳定地图标记",

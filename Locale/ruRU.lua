...
ns._activeTranslation = {
    ...
    ["Loading"] = "Загрузка",
    ["Rewards pending"] = "Награды ожидаются",
    ["Syncing rewards"] = "Синхронизация наград",
    ["No reward choices"] = "Нет вариантов награды",
    ["%d reward choices"] = "%d вариантов награды",
    ["Unknown reward"] = "Неизвестная награда",
    ["Quantity: %s"] = "Количество: %s",
    ["Hunt Sync"] = "Синхронизация охоты",
    ["No hunt signals detected."] = "Сигналы охоты не обнаружены.",
    ["Band %s | Active %d | Ready %d"] = "Категория %s | Активно %d | Готово %d",
    ["Tactical Hunt Console"] = "ТАКТИЧЕСКАЯ КОНСОЛЬ ОХОТЫ",
    ["Live prey routing, reward telemetry, and one-click quest access"] = "Живое отслеживание добычи, телеметрия наград и доступ к заданию в один клик",
    ["Detach"] = "Отстыковать",
    ["Dock"] = "Пристыковать",
    ["Synchronizing hunt deck"] = "Синхронизация списка охот",
    ["Stabilizing hunt signals"] = "Стабилизация сигналов охоты",
    ["Stabilizing map pins"] = "Стабилизация меток карты",

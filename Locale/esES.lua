...
ns._activeTranslation = {
    ...
    ["Keep the tracker on the prey icon or switch it to a movable floating layout."] = "Mantén el rastreador en el icono de presa o cámbialo a una disposición flotante.",
    ...
    ["Detach from prey icon"] = "Separar del icono de presa",
    ...
    ["Turn the tracker into a free-floating element you can place anywhere."] = "Convierte el rastreador en un elemento flotante que puedes colocar en cualquier lugar.",
    ["Keep the floating tracker fixed once it is where you want it."] = "Fija el rastreador flotante una vez que esté donde quieras.",
    ["Available after you switch the tracker to the floating layout."] = "Disponible tras cambiar al diseño flotante.",
    ["Bring the floating tracker back to the center of your screen."] = "Devuelve el rastreador flotante al centro de la pantalla.",
    ...
    ["Floating layout locked. Unlock it to drag the live tracker."] = "Disposición flotante bloqueada. Desbloquea para arrastrar el rastreador.",
    ["Floating layout ready. Drag the live tracker when a hunt is active."] = "Disposición flotante lista. Arrastra el rastreador cuando una cacería esté activa.",

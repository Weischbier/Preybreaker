...
ns._activeTranslation = {
    ...
    ["=== Prey Hunt Badge Diagnostic ==="] = "=== Diagnóstico do emblema da caçada de presa ===",
    ["No active hunt pins found."] = "Nenhum marcador de caçada ativo encontrado.",
    ["Unknown prey"] = "Presa desconhecida",
    ["Unknown difficulty"] = "Dificuldade desconhecida",
    ["Unknown zone"] = "Zona desconhecida",
    ["show icon"] = "mostrar ícone",
    ["hide icon"] = "ocultar ícone",
    ["none"] = "nenhum",
    ["Difficulty: %s"] = "Dificuldade: %s",
    ["This Prey target is a requirement for an unearned achievement."] = "Este alvo de presa é necessário para uma conquista ainda não obtida.",
    ...
    ["Loading"] = "Carregando",
    ["Rewards pending"] = "Recompensas pendentes",
    ["Syncing rewards"] = "Sincronizando recompensas",
    ["No reward choices"] = "Sem opções de recompensa",
    ["%d reward choices"] = "%d opções de recompensa",
    ["Unknown reward"] = "Recompensa desconhecida",
    ["Quantity: %s"] = "Quantidade: %s",
    ["Hunt Sync"] = "Sincronização de caça",
    ["No hunt signals detected."] = "Nenhum sinal de caça detectado.",
    ["Band %s | Active %d | Ready %d"] = "Faixa %s | Ativas %d | Prontas %d",
    ["Tactical Hunt Console"] = "CONSOLE TATICO DE CACA",
    ["Live prey routing, reward telemetry, and one-click quest access"] = "Rastreamento de presa em tempo real, telemetria de recompensas e acesso de missão com um clique",
    ["Detach"] = "Desanexar",
    ["Dock"] = "Anexar",
    ["Synchronizing hunt deck"] = "Sincronizando lista de caças",
    ["Stabilizing hunt signals"] = "Estabilizando sinais de caça",
    ["Stabilizing map pins"] = "Estabilizando pinos do mapa",

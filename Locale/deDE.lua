...
ns._activeTranslation = {
    ...
    ["Loading"] = "Lädt",
    ["Rewards pending"] = "Belohnungen ausstehend",
    ["Syncing rewards"] = "Belohnungen werden synchronisiert",
    ["No reward choices"] = "Keine Belohnungsauswahl",
    ["%d reward choices"] = "%d Belohnungsoptionen",
    ["Unknown reward"] = "Unbekannte Belohnung",
    ["Quantity: %s"] = "Menge: %s",
    ["Hunt Sync"] = "Jagdsynchronisierung",
    ["No hunt signals detected."] = "Keine Jagdsignale erkannt.",
    ["Band %s | Active %d | Ready %d"] = "Band %s | Aktiv %d | Bereit %d",
    ["Tactical Hunt Console"] = "TAKTISCHE JAGDKONSOLE",
    ["Live prey routing, reward telemetry, and one-click quest access"] = "Live-Beuteverfolgung, Belohnungstelemetrie und Questzugriff mit einem Klick",
    ["Detach"] = "Lösen",
    ["Dock"] = "Andocken",
    ["Synchronizing hunt deck"] = "Jagdliste wird synchronisiert",
    ["Stabilizing hunt signals"] = "Jagdsignale werden stabilisiert",
    ["Stabilizing map pins"] = "Kartenmarkierungen werden stabilisiert",

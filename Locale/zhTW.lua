...
ns._activeTranslation = {
    ...
    ["Commands: /pb, /pb settings, /pb toggle, /pb refresh, /pb hunts, /pb reset, /pb debug, /pb diag, /pb mapdump"] = "指令：/pb, /pb settings, /pb toggle, /pb refresh, /pb hunts, /pb reset, /pb debug, /pb diag, /pb mapdump",
    ["=== Prey Hunt Badge Diagnostic ==="] = "=== 獵物狩獵徽章診斷 ===",
    ["No active hunt pins found."] = "未找到啟用中的狩獵標記。",
    ["Unknown prey"] = "未知獵物",
    ...
    ["none"] = "無",
    ["Difficulty: %s"] = "難度：%s",
    ["This Prey target is a requirement for an unearned achievement."] = "此獵物目標是某項尚未取得成就的必要目標。",
    ...
    ["Syncing"] = "同步中",
    ["Loading"] = "載入中",
    ["Rewards pending"] = "獎勵待定",
    ["Syncing rewards"] = "正在同步獎勵",
    ["No reward choices"] = "沒有獎勵選項",
    ["%d reward choices"] = "%d個獎勵選項",
    ["Unknown reward"] = "未知獎勵",
    ["Quantity: %s"] = "數量：%s",
    ["Hunt Sync"] = "狩獵同步",
    ["No hunt signals detected."] = "未偵測到狩獵訊號。",
    ["Band %s | Active %d | Ready %d"] = "篩選%s | 進行中%d | 就緒%d",
    ["Tactical Hunt Console"] = "戰術狩獵控制台",
    ["Live prey routing, reward telemetry, and one-click quest access"] = "即時獵物追蹤、獎勵遙測與一鍵任務存取",
    ["Detach"] = "分離",
    ["Dock"] = "停靠",
    ["Synchronizing hunt deck"] = "正在同步狩獵清單",
    ["Stabilizing hunt signals"] = "正在穩定狩獵訊號",
    ["Stabilizing map pins"] = "正在穩定地圖標記",

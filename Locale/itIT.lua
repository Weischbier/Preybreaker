...
ns._activeTranslation = {
    ...
    ["Loading"] = "Caricamento",
    ["Rewards pending"] = "Ricompense in attesa",
    ["Syncing rewards"] = "Sincronizzazione ricompense",
    ["No reward choices"] = "Nessuna scelta ricompensa",
    ["%d reward choices"] = "%d scelte ricompensa",
    ["Unknown reward"] = "Ricompensa sconosciuta",
    ["Quantity: %s"] = "Quantità: %s",
    ["Hunt Sync"] = "Sincronizzazione caccia",
    ["No hunt signals detected."] = "Nessun segnale di caccia rilevato.",
    ["Band %s | Active %d | Ready %d"] = "Fascia %s | Attive %d | Pronte %d",
    ["Tactical Hunt Console"] = "CONSOLE TATTICA DI CACCIA",
    ["Live prey routing, reward telemetry, and one-click quest access"] = "Tracciamento preda in tempo reale, telemetria ricompense e accesso missione con un clic",
    ["Detach"] = "Sgancia",
    ["Dock"] = "Aggancia",
    ["Synchronizing hunt deck"] = "Sincronizzazione elenco cacce",
    ["Stabilizing hunt signals"] = "Stabilizzazione segnali di caccia",
    ["Stabilizing map pins"] = "Stabilizzazione indicatori mappa",

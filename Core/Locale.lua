...
local baseStrings = {
    ...
    ["Syncing rewards"] = "Syncing rewards",
    ["No reward choices"] = "No reward choices",
    ["%d reward choices"] = "%d reward choices",
    ["Unknown reward"] = "Unknown reward",
    ["Quantity: %s"] = "Quantity: %s",
    ["Hunt Sync"] = "Hunt Sync",
    ["No hunt signals detected."] = "No hunt signals detected.",
    ["Band %s | Active %d | Ready %d"] = "Band %s | Active %d | Ready %d",
    ["Tactical Hunt Console"] = "TACTICAL HUNT CONSOLE",
    ["Live prey routing, reward telemetry, and one-click quest access"] = "Live prey routing, reward telemetry, and one-click quest access",
    ["Detach"] = "Detach",
    ["Dock"] = "Dock",
    ["Synchronizing hunt deck"] = "Synchronizing hunt deck",
    ["Stabilizing hunt signals"] = "Stabilizing hunt signals",
    ["Stabilizing map pins"] = "Stabilizing map pins",
